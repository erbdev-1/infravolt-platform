...
| G0-DEC-007 | Engineering implementation is owned by Erhan Baydı and does not carry legal or commercial decision authority. | Founder / Engineering owner: Erhan Baydı | Defines the engineering ownership boundary. Legal, commercial, rights, and production approvals require authorised owners. | G0-COND-001 |
