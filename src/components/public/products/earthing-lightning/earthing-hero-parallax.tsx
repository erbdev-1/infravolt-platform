...
// CSS (see earthing-category-detail-page.module.css, section 03b) — this
// component does nothing else, and does nothing at all on touch devices or
// when the user has requested reduced motion.
const MAX_X_PX = 5;
const MAX_Y_PX = 4;

export function EarthingHeroParallax({
  children,
  className,
}: Readonly<{
  children: ReactNode;
