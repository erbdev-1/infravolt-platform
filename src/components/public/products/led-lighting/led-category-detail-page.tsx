...
import {
  INDUSTRIAL_HIGH_BAY_HERO_BACKGROUND,
  INDUSTRIAL_HIGH_BAY_HERO_BACKGROUND_ALT,
  INDUSTRIAL_HIGH_BAY_HERO_FOREGROUND,
  INDUSTRIAL_HIGH_BAY_HERO_FOREGROUND_ALT,
  INDUSTRIAL_HIGH_BAY_SUPPORT_CTA_IMAGE,
...
// LedProductFeatureIconName also covers "camera"/"powerline-comms" (added
// for the Smart Lighting & Automation category's own series cards) —
// this map must stay exhaustive over the full shared union even though
// Industrial & High-Bay's own data never uses those two keys.
const FEATURE_ICONS = {
...
export function LedCategoryDetailPage({
  ...
  const content = industrialHighBayLightingContentForMarket(market);

  return (
    <main className={styles.page}>
      <section className={styles.hero}>
        <Image
          alt={INDUSTRIAL_HIGH_BAY_HERO_BACKGROUND_ALT}
          className={styles.heroBackground}
          fill
          priority
          sizes="100vw"
          src={INDUSTRIAL_HIGH_BAY_HERO_BACKGROUND}
        />
        <div className={styles.heroScrim} />

        <div className={styles.heroForeground}>
          <Image
            alt={INDUSTRIAL_HIGH_BAY_HERO_FOREGROUND_ALT}
            fill
            priority
            sizes="(min-width: 1100px) 46vw, 90vw"
            src={INDUSTRIAL_HIGH_BAY_HERO_FOREGROUND}
      ...
      <section className={styles.supportCta}>
        <Image
          alt={INDUSTRIAL_HIGH_BAY_SUPPORT_CTA_IMAGE_ALT}
          className={styles.supportCtaImage}
          fill
          sizes="100vw"
          src={INDUSTRIAL_HIGH_BAY_SUPPORT_CTA_IMAGE}
        />
