...
import {
  LINEAR_TRUNKING_HERO_BACKGROUND,
  LINEAR_TRUNKING_HERO_BACKGROUND_ALT,
  LINEAR_TRUNKING_SUPPORT_CTA_IMAGE,
...
export function LedCategoryDetailPageLinearTrunking({
  ...
  const content = linearTrunkingLightingContentForMarket(market);

  return (
    <main className={styles.page}>
      <section className={styles.hero}>
        <Image
          alt={LINEAR_TRUNKING_HERO_BACKGROUND_ALT}
          className={styles.heroBackground}
          fill
          priority
          sizes="100vw"
          src={LINEAR_TRUNKING_HERO_BACKGROUND}
        />
      ...
      <section className={styles.supportCta}>
        <Image
          alt={LINEAR_TRUNKING_SUPPORT_CTA_IMAGE_ALT}
          className={styles.supportCtaImage}
          fill
          sizes="100vw"
          src={LINEAR_TRUNKING_SUPPORT_CTA_IMAGE}
        />
