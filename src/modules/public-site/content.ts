  ...
  ua: {
    ...
    support: {
      ...
      showroom: {
        ...
        title: "Технічна підтримка та підбір рішень",
        description:
          "Технічний супровід і підбір рішень Gersan для шинопроводів, кабельних трас, заземлення, підпідлогових, освітлювальних і зарядних систем — під конкретні вимоги проєкту.",
        status: "Технічна підтримка та підбір рішень за запитом.",
        imageAlt:
          "Технічний фахівець InfraVolt консультує з підбору рішень Gersan",
      },

      warehouse: {
        eyebrow: "Постачання та логістика",
        title: "Координація постачання та логістики проєктів",
        description:
          "Планування поставок, узгодження термінів і координація логістики для проєктів в Україні — від підтвердженого обсягу до доставки.",
        status: "Координація постачання за проєктними запитами.",
        imageAlt:
          "Координація постачання та логістики проєктів InfraVolt в Україні",
      },
