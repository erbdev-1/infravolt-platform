...
const content = {
  ...
  ua: {
    metadata: {
      title: "Підлогові та внутрішньопідлогові кабельні системи | InfraVolt",
      description:
        "Підлогові та внутрішньопідлогові кабельні системи для комерційних приміщень — підлогові коробки GDK, розетки та аксесуари GDKF, кабельні лотки GDK, канали GYDK для фальшпідлоги та алюмінієві канали GOR, з технічною підтримкою проєктів від InfraVolt.",
    },
    breadcrumbs: {
      home: "Головна",
      products: "Продукція",
      current: "Підлогові та внутрішньопідлогові кабельні системи",
    },
    backToHomeLabel: "На головну",
    hero: {
      eyebrow: "КАБЕЛЬНИЙ КАНАЛ ПІД ПІДЛОГОЮ",
      title: "Підлогові та внутрішньопідлогові кабельні системи",
      description:
    ...
    heroVisualImage: UNDERFLOOR_HERO_VISUAL_IMAGE,
    heroVisualImageAlt:
      "Композиція підлогових розподільних коробок і кабельних лотків",
    overviewHeading: "Технічний огляд",
    overview: [
      {
        icon: "distribution",
        title: "Гнучкий розподіл під підлогою",
        description: "Електроживлення та дані можна розподіляти під готовою підлогою за допомогою модульних каналів і точок доступу.",
      },
      {
        icon: "integration",
        title: "Інтеграція живлення та даних",
        description: "Інтегроване прокладання кабелів підтримує електричні та інформаційні мережі в плануванні комерційних приміщень.",
      },
      {
        icon: "access",
        title: "Модульний доступ до підлоги",
        description: "Підлогові коробки та точки доступу забезпечують зручний доступ до електроживлення та даних поблизу робочих місць і обладнання.",
      },
      {
        icon: "adaptable",
        title: "Гнучке планування комерційних приміщень",
        description:
          "Розподіл під підлогою підтримує зміну офісного та комерційного планування, не покладаючись виключно на фіксовані периметральні точки живлення.",
      },
    ],
    seriesHeading: "Продуктові серії в цій системі",
    seriesIntroduction: "Шість перевірених каталожних серій, що охоплюють підлогові та внутрішньопідлогові кабельні системи.",
    ...
    series: [
      {
        slug: "underfloor-junction-boxes",
        number: "01",
        name: "GDK Підлогові та розподільні коробки",
        description: "Підлогові коробки та розподільні коробки для розеток живлення й даних, у виконаннях GDK, GDK-Y та британського варіанта (ING).",
        features: [
        ...
        image: UNDERFLOOR_SERIES_ASSETS["underfloor-junction-boxes"].categoryCard,
        imageAlt: "Підлогова розподільна коробка GDK-31-Y, відкрита кришка з внутрішнім відсіком для розеток",
        href: "/products/underfloor-systems/underfloor-junction-boxes",
      },
      {
        slug: "socket-data-accessories",
        number: "02",
        name: "GDKF Розетки та аксесуари для підлогових коробок",
        description: "Вставки розеток живлення, із заземленням, даних (RJ-45) та телефону (RJ-11/RJ12), а також розетки 13A BS, що використовуються з підлоговими коробками GDK та алюмінієвим каналом GOR.",
        features: [
          { icon: "configuration", label: "Живлення / Дані / Телефон" },
          { icon: "capacity", label: "16 каталожних моделей" },
          { icon: "mounting", label: "Для коробок GDK і каналу GOR" },
        ],
        image: UNDERFLOOR_SERIES_ASSETS["socket-data-accessories"].categoryCard,
      ...
      },
      {
        slug: "underfloor-cable-trays",
        number: "03",
        name: "GDK Кабельні лотки під підлогою",
        description: "Суцільні та перфоровані кабельні лотки для прокладання під підлогою, трьох ширин, з відповідними елементами з'єднання, заглушками та поворотами 90°.",
        features: [
        ...
        image: UNDERFLOOR_SERIES_ASSETS["underfloor-cable-trays"].categoryCard,
        imageAlt: "Перфорований підлоговий кабельний лоток GDK-24-B",
        href: "/products/underfloor-systems/underfloor-cable-trays",
      },
      {
        slug: "raised-floor-trunking",
        number: "04",
        name: "GYDK Кабельні канали для фальшпідлоги",
        description: "Заглиблений канал для фальшпідлоги та відповідні кришки п'яти ширин і трьох висот для прокладки кабелів під фальшпідлогою.",
        features: [
        ...
        image: UNDERFLOOR_SERIES_ASSETS["raised-floor-trunking"].categoryCard,
        imageAlt: "Композиція категорії кабельних каналів GYDK для фальшпідлоги",
        href: "/products/underfloor-systems/raised-floor-trunking",
      },
      {
        slug: "aluminium-trunking",
        ...
        description: "Одно-, двовідсіковий та двосторонній (спина до спини) алюмінієвий накладний канал з відповідними поворотами, кришками та заглушками.",
        features: [
          { icon: "configuration", label: "Один / Два відсіки / Двосторонній" },
          { icon: "capacity", label: "13 каталожних моделей" },
          { icon: "material", label: "Анодований алюміній" },
        ],
        image: UNDERFLOOR_SERIES_ASSETS["aluminium-trunking"].categoryCard,
      ...
      },
      {
        slug: "tray-accessories",
        number: "06",
        name: "GDK Аксесуари для кабельних лотків під підлогою",
        description: "Елементи з'єднання, заглушки та повороти 90° (GDKE / GDKS / GDKD) для асортименту кабельних лотків GDK під підлогою.",
        features: [
          { icon: "configuration", label: "З'єднання / Заглушка / Поворот 90°" },
          { icon: "capacity", label: "11 каталожних моделей" },
        ],
        image: UNDERFLOOR_SERIES_ASSETS["tray-accessories"].categoryCard,
        imageAlt: "Аксесуар повороту 90° GDKD-18 для кабельних лотків GDK під підлогою",
        href: "/products/underfloor-systems/tray-accessories",
      },
    ],
    systemHeading: "Як працює підлогова кабельна система",
    systemIntroduction: "Схема системи з каталогу виробника — три пов'язані етапи.",
    systemSteps: [
      {
        icon: "trunking",
        title: "Розподільний канал",
        description: "Алюмінієвий канал GOR або канал GYDK для фальшпідлоги прокладає кабелі під готовою підлогою або в її порожнині.",
      },
      {
        icon: "junction",
        title: "Підлогова розподільна коробка",
    ...
    constructionOptions: [
      {
        ...
        description: "Кабельні лотки GDK під підлогою доступні без отворів (суцільні) або з отворами (перфоровані) у відповідних ширинах.",
      },
      {
        title: "Стандартна, середня або висока порожнина каналу",
        description: "Канал для фальшпідлоги GYDK доступний висотою 50 мм, 60 мм та 100 мм у п'яти ширинах.",
      },
      {
        title: "Одно-, двовідсіковий або двосторонній канал",
      ...
      },
      {
        ...
        description: "Підлогові розподільні коробки доступні в стандартній конфігурації GDK або британському варіанті (ING).",
      },
    ],
    applicationsHeading: "Типові застосування",
    applications: [
      { icon: "office", title: "Офіси та робочі простори", description: "Гнучкий доступ до живлення та даних у відкритих та кабінетних офісних плануваннях.", image: UNDERFLOOR_APPLICATION_IMAGES.office, imageAlt: "Підлогові системи в сучасному офісному просторі" },
      { icon: "commercial-building", title: "Комерційні будівлі", description: "Розподіл живлення та даних під підлогою для багатофункціональних і багатоорендних комерційних приміщень.", image: UNDERFLOOR_APPLICATION_IMAGES["commercial-building"], imageAlt: "Підлогові системи в комерційній будівлі" },
      { icon: "meeting-room", title: "Переговорні та конференц-зали", description: "Доступ до живлення та даних на рівні підлоги для гнучких переговорних та презентаційних планувань.", image: UNDERFLOOR_APPLICATION_IMAGES["meeting-room"], imageAlt: "Підлогові системи в переговорному та конференц-просторі" },
      { icon: "education", title: "Освітні заклади", description: "Прокладання під підлогою кабелів живлення та даних для класних кімнат і навчальних просторів.", image: UNDERFLOOR_APPLICATION_IMAGES.education, imageAlt: "Підлогові системи в освітньому закладі" },
      { icon: "retail", title: "Роздрібні приміщення", description: "Адаптований доступ до підлоги для потреб живлення торгових точок, вітрин та обладнання.", image: UNDERFLOOR_APPLICATION_IMAGES.retail, imageAlt: "Підлогові системи в роздрібному інтер’єрі" },
      { icon: "flexible-workspace", title: "Зони гнучкої роботи та керування", description: "Розподіл живлення та даних, що підтримує часто змінюване планування робочих місць та обладнання.", image: UNDERFLOOR_APPLICATION_IMAGES["flexible-workspace"], imageAlt: "Підлогові системи в зоні керування та гнучкої роботи" },
    ],
    supportCta: {
      eyebrow: "ПІДТРИМКА ПРОЄКТУ",
      title: "Плануєте систему підлогового кабельного розподілу?",
      description: "Наша команда допоможе визначити правильну конфігурацію каналів, доступу до підлоги та розподілу живлення й даних для вашого проєкту.",
      action: "Звернутися до технічної команди",
    },
    seriesDetail: {
      backLabel: "До підлогових та внутрішньопідлогових кабельних систем",
