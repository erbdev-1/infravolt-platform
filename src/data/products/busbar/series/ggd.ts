...
export const GGD_SYSTEM_DETAIL = {
  ...
  ua: {
    ...
    heroDescription:
      "GGD — магістральна шинопровідна система середньої потужності на 160–1000 А для промислового та комерційного розподілу електроенергії. Доступна у варіантах з алюмінієвими (GGD-A, до 1000 А) або мідними (GGD-C, до 800 А) провідниками, з одноболтовою моноблочною системою з'єднання, спеціальними підвісами для вертикальних систем розподілу та широким асортиментом кутових, зміщувальних, компенсаційних, ввідних та відгалужувальних аксесуарів.",
    heroFeatureImage: `${IMAGE_BASE}/card/ggd-main-transparent-product.webp`,
