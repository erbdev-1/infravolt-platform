...
const CABLE_MANAGEMENT_LABELS_BY_MARKET: Readonly<Record<MarketCode, CableManagementLabels>> = {
  uk: {
    ...
    widthFilterLabel: "Width (mm)",
    heightFilterLabel: "Height (mm)",
    thicknessFilterLabel: "Thickness (mm)",
    filterPanelTitle: "Filter & Search",
  ...
  ua: {
    ...
    familyFilterLabel: "Серія",
    typeFilterLabel: "Тип",
    widthFilterLabel: "Ширина (мм)",
    heightFilterLabel: "Висота (мм)",
    thicknessFilterLabel: "Товщина (мм)",
    filterPanelTitle: "Фільтр і пошук",
    clearAllAction: "Очистити все",
    applyFiltersAction: "Застосувати фільтри",
