...
const EARTHING_HUB_CONTENT = {
  ...
  ua: {
    ...
    hero: {
      ...
      subtitle:
        "Комплексні рішення заземлення, блискавкозахисту та вирівнювання потенціалів для комерційних, промислових та інфраструктурних проєктів.",
      description:
    ...
    technicalSnapshot: [
      ...
      },
      {
        ...
        value: ["Заземлення", "Блискавкозахист", "Вирівнювання потенціалів", "Статичне та Ex-proof"],
      },
      {
        icon: "clock",
        label: "Термін служби",
    ...
    pathways: [
      ...
      {
        id: "equipotential-bonding",
        title: "Вирівнювання потенціалів",
        description:
          "Мідні, луджені мідні та оцинковані шини вирівнювання потенціалів з тестовими та роз'єднувальними перемичками.",
      },
      {
        id: "industrial-hazardous-grounding",
    ...
    categoriesIntroduction:
      "Вісім інженерних продуктових сімейств для заземлення, блискавкозахисту та вирівнювання потенціалів, побудованих на основі повного каталогу заземлення та блискавкозахисту Gersan.",
    categories: [
      {
        slug: "lightning-protection",
      ...
      },
      {
        ...
        description:
          "Клеми для електродів, провідників, перехідні та тестові клеми, розроблені для надійних з'єднань вирівнювання потенціалів згідно зі стандартами.",
      ...
      {
        slug: "equipotential-earth-bars",
        name: "Шини вирівнювання потенціалів",
        description:
          "Мідні, луджені мідні та оцинковані шини вирівнювання потенціалів з одинарними та подвійними роз'єднувальними перемичками, можливе виготовлення нестандартної довжини.",
        materials: "Мідь · Луджена мідь · Оцинкована сталь",
        familyCount: "1 продуктове сімейство",
        image: `${IMAGE_BASE}/equipotential-earth-bars/card/equal-potential-bar-copper-geb-t.webp`,
        heroImage: `${IMAGE_BASE}/equipotential-earth-bars/card/equal-potential-bar-copper-geb-t-hero.webp`,
        imageAlt: "Мідна шина вирівнювання потенціалів Gersan, серія GEB-T",
        technicalSnapshot: [
          {
            icon: "shield",
            label: "Застосовні стандарти",
          ...
          {
            icon: "bond",
            label: "Застосування вирівнювання потенціалів",
      ...
      },
      {
        ...
        technicalSnapshot: [
          ...
          { icon: "bond", label: "Застосування", value: ["Заземлення", "Вирівнювання потенціалів", "З'єднання підстанцій"] },
          {
            icon: "support",
            label: "Підтримка монтажу",
    ...
    guidance: [
      {
        ...
        description:
          "Як струми короткого замикання та блискавки безпечно відводяться в землю через електроди, провідники та з'єднання вирівнювання потенціалів.",
      },
      {
      ...
      {
        title: "Принципи вирівнювання потенціалів",
        description:
    ...
    principles: [
      ...
      "Ефективне вирівнювання потенціалів",
    ],
    ...
    applications: [
      {
        ...
        description:
          "Блискавкозахист, електроди заземлення та вирівнювання потенціалів для офісів, торгових та багатофункціональних об'єктів.",
        image: `${IMAGE_BASE}/applications/earthing-application-commercial-buildings.webp`,
      ...
      },
      {
        ...
        description:
          "Заземлення, вирівнювання потенціалів та блискавкозахист для виробничих цехів, технологічних зон та технічних приміщень.",
        image: `${IMAGE_BASE}/applications/earthing-application-industrial-facilities.webp`,
      ...
      },
      {
        ...
        description:
          "Заземлення з низьким опором та вирівнювання потенціалів для чутливої електротехнічної та ІТ-інфраструктури.",
        image: `${IMAGE_BASE}/applications/earthing-application-data-centres.webp`,
      ...
      },
      {
        ...
        description:
          "Заземлення, вирівнювання потенціалів та блискавкозахист для складських і логістичних об'єктів великого прольоту.",
        image: `${IMAGE_BASE}/applications/earthing-application-warehouses-logistics.webp`,
      ...
      },
      {
        ...
        description:
          "Заземлення та вирівнювання потенціалів для лікарень і клінічних будівель з чутливими медичними електротехнічними системами.",
        image: `${IMAGE_BASE}/applications/earthing-application-healthcare.webp`,
    ...
    support: {
      ...
      description:
        "Від вибору електродів до повних схем вирівнювання потенціалів — наша команда підтримує специфікацію, технічні дані та монтажні рекомендації.",
