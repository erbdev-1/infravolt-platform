...
const content = {
  ...
  ua: {
    metadata: {
      ...
      description:
        "Каталожно підтверджені системи вуличного LED-освітлення, прожекторного освітлення та освітлення тунелів GER-LED і LED-BUS для доріг, великих відкритих просторів, навісів та архітектурних фасадів.",
    },
    breadcrumbs: {
      home: "Головна",
      products: "Продукція",
