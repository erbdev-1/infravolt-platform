...
const content = {
  ...
  ua: {
    metadata: {
      title: "Промислове LED-освітлення для високих приміщень | InfraVolt",
      description:
        "LEDBUS Промислове LED-освітлення для високих приміщень — шість каталожних продуктових серій для заводів, складів, ангарів та логістичних об'єктів, 35–250 Вт, IP20–IP66.",
    },
    breadcrumbs: {
      home: "Головна",
      products: "Продукція",
      ledSystems: "Системи LED-освітлення",
      current: "Промислове LED-освітлення для високих приміщень",
    },
    backToLedSystemsLabel: "Назад до систем LED-освітлення",
    hero: {
      eyebrow: "СИСТЕМИ LED",
      title: "Промислове LED-освітлення для високих приміщень",
      description:
    ...
    seriesIntroduction:
      "Шість реальних каталожних серій LEDBUS та GER-LED, що охоплюють діапазон промислового LED-освітлення для високих приміщень.",
    ...
    series: [
      ...
      },
      {
        ...
        name: "LED-BUS LDB-FL Series Lighting Systems",
        description:
          "73O-LDB1FL – 73O-LDB4FL, високостельові прожектори зі сталевим корпусом та загартованим склом 4 мм. У каталозі вказані варіанти керування 1-10V, DALI, Touch-Dim та Casambi.",
        features: [
    ...
    applications: [
      {
        ...
        image: `${APPLICATION_IMAGE_BASE}/factory-halls-application.webp`,
        imageAlt:
          "Високостельові світильники LED освітлюють сталевий каркас промислового даху",
      },
      {
        title: "Склади та логістика",
        image: `${APPLICATION_IMAGE_BASE}/warehouses-logistics-application.webp`,
        imageAlt:
          "Прохід складу зі стелажами та навантажувачем, освітлений високостельовими світильниками LED",
      },
      {
        title: "Авіаційні ангари",
        image: `${APPLICATION_IMAGE_BASE}/aircraft-hangars-application.webp`,
        imageAlt:
          "Ангар для складання літаків, освітлений високостельовими світильниками LED",
      },
      {
