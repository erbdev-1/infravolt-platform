            ...
            {category === "all" ? (
              ...
              >
                <div className={styles.applicationsHeading}>
                  <div
                    className={styles.applicationsTitleRow}
                    style={{
                      alignItems: "baseline",
                      display: "flex",
                      flexDirection: "row",
                  ...
                  >
                    <p className={styles.applicationsLabel}>
                      {content.applications.eyebrow}
                    </p>

                    <h2
                      id="busbar-applications-title"
                      style={{
                        fontSize: "1.55rem",
                        lineHeight: 1,
                        margin: 0,
          ...
          <div>
            <div className={styles.supportIdentity}>
              ...
              <p className={styles.supportEyebrow}>
                {content.projectSupport.eyebrow}
              </p>
            </div>
