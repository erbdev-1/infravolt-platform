...
export async function generateMetadata(): Promise<Metadata> { const market = resolveTrustedMarketContext(await headers()); const content = lwConfigurationsForMarket(market.market)[0].content; return marketPageMetadata({
