...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return { title: content.metadata.title, description: content.metadata.description, alternates: { canonical: new URL(`${SPECIAL_HAZARDOUS_CATEGORY_HREF}/${SERIES_SLUG}`, marketContext.publicSiteUrl) } };
}
