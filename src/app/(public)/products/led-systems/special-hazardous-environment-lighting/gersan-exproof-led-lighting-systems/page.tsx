...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return { title: ldbexp.metadata.title, description: ldbexp.metadata.description, alternates: { canonical: new URL(`${SPECIAL_HAZARDOUS_CATEGORY_HREF}/${SERIES_SLUG}`, marketContext.publicSiteUrl) } };
}
