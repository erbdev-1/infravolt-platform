...
export async function generateMetadata(): Promise<Metadata> { const market = resolveTrustedMarketContext(await headers()); const content = squareRingContentForMarket(market.market); return marketPageMetadata({
