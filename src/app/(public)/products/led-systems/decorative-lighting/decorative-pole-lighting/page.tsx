...
export async function generateMetadata(): Promise<Metadata> { const market = resolveTrustedMarketContext(await headers()); const content = decorativePoleContentForMarket(market.market); return marketPageMetadata({
