...
export async function generateMetadata(): Promise<Metadata> { const market = resolveTrustedMarketContext(await headers()); const content = vlDecorativeContentForMarket(market.market); return marketPageMetadata({
